...
const tastingNotes = [
  { name: 'Rich & Velvety', notes: 'Deep cocoa depth with a smooth, melt-in-the-mouth finish', color: '#d4a373' },
  { name: 'Signature Crunch', notes: 'Toasted nuts and pralines for a satisfying bite', color: '#c9a96e' },
  { name: 'Delicately Sweet', notes: 'Balanced sweetness that never overwhelms', color: '#b89660' },
];
    ...
    <section className="py-16 lg:py-24" style={{ position: 'relative', overflow: 'hidden', background: 'linear-gradient(160deg, var(--bg-dark) 0%, var(--bg-warm) 50%, var(--bg-dark) 100%)' }}>
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-24 items-center">
          ...
          >
            <div className="section-label mb-5">Crafted With Care</div>
            ...
            <h2 className="font-luxury font-semibold leading-[1.08] mb-6"
              ...
              Handcrafted With<br />
              <em className="text-luxury-gradient" style={{ fontStyle: 'italic', fontWeight: 400 }}>India's Finest Ingredients</em>
            </h2>

            <p className="text-base leading-relaxed mb-8 max-w-[480px] font-sans" style={{ color: 'var(--muted)' }}>
              Every DUMUZI creation is handcrafted in India using premium, carefully selected ingredients — slow-tempered and finished by hand for a taste that's rich, smooth, and unmistakably indulgent.
            </p>

            {/* Tasting Notes */}
            <div className="flex flex-col gap-3 mb-10">
              {tastingNotes.map(({ name, notes, color }) => (
                <div key={name}
                  className="flex items-center gap-4 p-4 rounded-2xl"
                  style={{ background: 'rgba(15,10,7,0.5)', border: `1px solid ${color}28`, backdropFilter: 'blur(12px)' }}>
                  <span className="w-9 h-9 rounded-xl flex items-center justify-center flex-shrink-0" style={{ background: `${color}1f` }}>
          ...
          >
            ...
            <div className="relative rounded-[36px] overflow-hidden group"
              ...
              <img
                ...
                alt="DUMUZI Diamond Tray — 15 Trios"
              ...
              <div className="absolute inset-0 flex flex-col justify-end p-8 z-10">
                ...
                <p className="font-display text-lg italic mb-1" style={{ color: 'var(--cream)', fontWeight: 500, lineHeight: 1.4 }}>
                  "Every piece is hand-tempered and finished for a flawless, glossy shine."
                </p>
                <p className="text-[10px] uppercase tracking-widest font-semibold mt-1" style={{ color: GOLDL }}>
                  DUMUZI Confectioners
                </p>
              </div>
            ...
            >
              ...
              <div>
                <p className="font-display text-lg font-bold" style={{ color: 'var(--cream)' }}>4</p>
                <p className="text-[9px] uppercase tracking-wider" style={{ color: 'var(--muted)' }}>Signature Collections</p>
              </div>
            </motion.div>
          </motion.div>
